...
.method private getInterfaceCounter(Ljava/lang/String;Z)J
    ...
    const-string v6, "interface read%scounter %s"
    ...
    const-string v6, "Failed to read interface %s counters"
...
.method public disableNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "nat disable %s %s"
...
.method public enableNat(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "nat enable %s %s"
...
.method public getDnsForwarders()[Ljava/lang/String;
    ...
    const-string v1, "tether dns list"

    const/16 v2, 0x70

    invoke-virtual {v0, v1, v2}, Lcom/android/server/NativeDaemonConnector;->doListCommand(Ljava/lang/String;I)[Ljava/lang/String;
...
.method public getInterfaceConfig(Ljava/lang/String;)Landroid/net/InterfaceConfiguration;
    ...
    const-string v10, "NetworkManagmentService"
    ...
    const-string v8, "interface getcfg "
    ...
    const-string v7, "Expected code %d, but got %d"
    ...
    const-string v7, "Invalid response from daemon (%s)"
    ...
    iput-object v6, v0, Landroid/net/InterfaceConfiguration;->hwAddr:Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/android/server/NetworkManagementService;->stringToIpAddr(Ljava/lang/String;)I

    move-result v6

    iput v6, v0, Landroid/net/InterfaceConfiguration;->ipAddr:I
    :try_end_1
    ...
    iput v6, v0, Landroid/net/InterfaceConfiguration;->netmask:I
    :try_end_2
    ...
    iput-object v6, v0, Landroid/net/InterfaceConfiguration;->interfaceFlags:Ljava/lang/String;

    .line 267
    const-string v6, "NetworkManagmentService"

    const-string v6, "flags <%s>"

    new-array v7, v12, [Ljava/lang/Object;

    iget-object v8, v0, Landroid/net/InterfaceConfiguration;->interfaceFlags:Ljava/lang/String;
    ...
    .line 257
    iput v11, v0, Landroid/net/InterfaceConfiguration;->ipAddr:I
    ...
    .line 263
    .restart local v5       #uhe:Ljava/net/UnknownHostException;
    const-string v6, "NetworkManagmentService"

    const-string v6, "Failed to parse netmask"

    invoke-static {v10, v6, v5}, Landroid/util/Slog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    .line 264
    iput v11, v0, Landroid/net/InterfaceConfiguration;->netmask:I
...
.method public getIpForwardingEnabled()Z
    ...
    const-string v6, "Malformatted list entry \'%s\'"
...
.method public isUsbRNDISStarted()Z
    ...
    const-string v6, "usb rndisstatus"
...
.method public listInterfaces()[Ljava/lang/String;
    ...
    const-string v1, "interface list"
...
.method public listTetheredInterfaces()[Ljava/lang/String;
    ...
    const-string v1, "tether interface list"
...
.method public setAccessPoint(Landroid/net/wifi/WifiConfiguration;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v8}, Landroid/content/Context;->enforceCallingOrSelfPermission(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "setAccessPoint \n"
...
.method public setInterfaceConfig(Ljava/lang/String;Landroid/net/InterfaceConfiguration;)V
    ...
    .prologue
    .line 273
    const-string v1, "interface setcfg %s %s %s %s"
    ...
    iget v4, p2, Landroid/net/InterfaceConfiguration;->ipAddr:I

    invoke-static {v4}, Lcom/android/server/NetworkManagementService;->intToIpString(I)Ljava/lang/String;
    ...
    iget v4, p2, Landroid/net/InterfaceConfiguration;->netmask:I
    ...
    iget-object v4, p2, Landroid/net/InterfaceConfiguration;->interfaceFlags:Ljava/lang/String;
...
.method public setInterfaceThrottle(Ljava/lang/String;II)V
    ...
    const-string v1, "interface setthrottle %s %d %d"
...
.method public startUsbRNDIS()V
    ...
    const-string v1, "usb startrndis"
...
.method public tetherInterface(Ljava/lang/String;)V
    ...
    const-string v2, "tether interface add "
...
.method public untetherInterface(Ljava/lang/String;)V
    ...
    const-string v2, "tether interface remove "
