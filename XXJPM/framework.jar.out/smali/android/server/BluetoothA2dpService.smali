...
.field private static final ENABLE_AUTO_CONNECT:Z = true
...
.method static synthetic access$1100(Landroid/server/BluetoothA2dpService;[I)Ljava/util/Set;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1200(Landroid/server/BluetoothA2dpService;Z)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1300(Landroid/server/BluetoothA2dpService;Landroid/bluetooth/BluetoothDevice;II)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
    ...
    .prologue
    .line 49
    invoke-direct {p0, p1, p2, p3}, Landroid/server/BluetoothA2dpService;->connectSinkInt(Landroid/bluetooth/BluetoothDevice;II)Z
...
.method static synthetic access$500(Landroid/server/BluetoothA2dpService;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private checkSinkSuspendState(I)Z
    ...
    iput-boolean v1, p0, Landroid/server/BluetoothA2dpService;->mSuspended:Z
...
.method private declared-synchronized completeBluetoothDisable(Z)Z
    ...
    const-string v8, "There are active sinks. Delay turning off BT."
...
.method private declared-synchronized connectSinkInt(Landroid/bluetooth/BluetoothDevice;II)Z
    .locals 8
    .parameter "device"
    .parameter "connectDelayMs"
    .parameter "disconnectDelayMs"
    ...
    const-string v4, "connectSinkInt("
    ...
    const-string v5, "Oops, connectSink "
    ...
    const-string v4, "Oops, there are active sinks. Send delayed connect msg."
...
.method private declared-synchronized disconnectAllConnectedSinks()V
    ...
    invoke-direct {p0, v4}, Landroid/server/BluetoothA2dpService;->lookupSinksMatchingStates([I)Ljava/util/Set;

    move-result-object v3

    .line 452
    .local v3, sinks:Ljava/util/Set;,"Ljava/util/Set<Landroid/bluetooth/BluetoothDevice;>;"
    invoke-interface {v3}, Ljava/util/Set;->size()I
    ...
    const-string v5, "Disconnect connected sink "
    ...
    .line 457
    invoke-direct {p0, v1}, Landroid/server/BluetoothA2dpService;->disconnectSinkNative(Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v3           #sinks:Ljava/util/Set;,"Ljava/util/Set<Landroid/bluetooth/BluetoothDevice;>;"
    :catchall_0
    move-exception v4
    ...
    .line 461
    .restart local v3       #sinks:Ljava/util/Set;,"Ljava/util/Set<Landroid/bluetooth/BluetoothDevice;>;"
    :cond_1
    monitor-exit p0
...
.method private declared-synchronized onBluetoothEnable()V
    ...
    iput-boolean v9, p0, Landroid/server/BluetoothA2dpService;->mSuspended:Z
...
.method private declared-synchronized onSinkPropertyChanged(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v6, "onSinkPropertyChanged: Address of the remote device is null"
...
.method public declared-synchronized connectSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/server/BluetoothA2dpService;->connectSinkInt(Landroid/bluetooth/BluetoothDevice;II)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized disconnectSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    const-string v4, "Oops, disconnectSink "
    ...
    const-string v4, " but BT is not enabled."
...
.method public declared-synchronized resumeSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    const-string v4, "Oops, resumeSink "
...
.method public declared-synchronized suspendSink(Landroid/bluetooth/BluetoothDevice;)Z
    ...
    const-string v4, "Oops, suspendSink "
