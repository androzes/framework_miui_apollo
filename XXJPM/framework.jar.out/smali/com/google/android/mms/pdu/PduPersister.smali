...
.method private loadParts(J)[Lcom/google/android/mms/pdu/PduPart;
    ...
    .line 352
    .local v34, parts:[Lcom/google/android/mms/pdu/PduPart;
    if-eqz v15, :cond_0
    ...
    .line 363
    new-instance v27, Lcom/google/android/mms/pdu/PduPart;

    invoke-direct/range {v27 .. v27}, Lcom/google/android/mms/pdu/PduPart;-><init>()V
    ...
    .line 412
    .local v35, strName:Ljava/lang/String;
    :try_start_2
    ...
    .end local v35           #strName:Ljava/lang/String;
    .local v36, strName:Ljava/lang/String;
    move-object/from16 v35, v36

    .line 417
    .end local v36           #strName:Ljava/lang/String;
    .restart local v35       #strName:Ljava/lang/String;
    :goto_2
    :try_start_3
    const-string v4, "."
    ...
    .line 427
    .local v33, partURI:Landroid/net/Uri;
    move-object/from16 v0, v27
    ...
    invoke-static/range {v38 .. v38}, Lcom/google/android/mms/ContentType;->isImageType(Ljava/lang/String;)Z

    move-result v4

    if-nez v4, :cond_c

    invoke-static/range {v38 .. v38}, Lcom/google/android/mms/ContentType;->isAudioType(Ljava/lang/String;)Z

    move-result v4

    if-nez v4, :cond_c

    invoke-static/range {v38 .. v38}, Lcom/google/android/mms/ContentType;->isVideoType(Ljava/lang/String;)Z
    ...
    .end local v32           #partIdx:I
    .restart local v31       #partIdx:I
    aput-object v27, v34, v32

    move/from16 v32, v31

    .line 475
    .end local v31           #partIdx:I
    .restart local v32       #partIdx:I
    goto/16 :goto_1

    .line 393
    .end local v22           #fileName:[B
    .end local v26           #name:[B
    .end local v29           #partId:J
    .end local v33           #partURI:Landroid/net/Uri;
    ...
    .restart local v29       #partId:J
    .restart local v33       #partURI:Landroid/net/Uri;
