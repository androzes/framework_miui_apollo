...
.field static final nationalRoaming:[[[Ljava/lang/String; = null
...
.method static constructor <clinit>()V
    ...
    const-string v4, "21416"

    aput-object v4, v2, v3

    const/4 v3, 0x6

    const-string v4, "21419"
    ...
    sput-object v0, Lcom/android/internal/telephony/gsm/SIMRecords;->nationalRoaming:[[[Ljava/lang/String;
...
.method static isNationalRoaming(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 7
    .parameter "spn"
    .parameter "plmn"
    ...
    .local v2, i:I
    :goto_1
    sget-object v0, Lcom/android/internal/telephony/gsm/SIMRecords;->nationalRoaming:[[[Ljava/lang/String;
    ...
    .line 2694
    .local v3, roamingData:[[Ljava/lang/String;
    if-eqz v3, :cond_2
    ...
    const-string v5, "isNationalRoaming(): invalid entry: ["
    ...
    .end local v3           #roamingData:[[Ljava/lang/String;
    ...
    .line 2701
    .restart local v3       #roamingData:[[Ljava/lang/String;
    :cond_4
    const/4 v0, 0x0
    ...
    .line 2702
    .local v5, sales_codes:[Ljava/lang/String;
    if-eqz v5, :cond_3
    ...
    .local v5, simMccMncs:[Ljava/lang/String;
    if-eqz v5, :cond_3
    ...
    .line 2743
    .end local v0           #found:Z
    .local v3, networkMccMncs:[Ljava/lang/String;
    if-eqz v3, :cond_3

    .line 2747
    const/4 v0, 0x0

    .end local v5           #simMccMncs:[Ljava/lang/String;
    .local v0, j:I
    :goto_5
    array-length v1, v3
    ...
    .line 2764
    .end local v0           #j:I
    .end local v3           #networkMccMncs:[Ljava/lang/String;
    :cond_c
    const/4 p0, 0x0
    ...
    .local v1, found:Z
    .local v3, roamingData:[[Ljava/lang/String;
    .restart local v5       #simMccMncs:[Ljava/lang/String;
    :cond_d
    move v0, v1
...
.method protected getDisplayRule(Ljava/lang/String;)I
    ...
    const-string v4, "[getDisplayRule] spn string == plmn string, showing only spn"
    ...
    const-string v4, "[getDisplayRule] Showing plmn (spnDisplayCondition & 1)"
    ...
    invoke-static {v4, p1}, Lcom/android/internal/telephony/gsm/SIMRecords;->isNationalRoaming(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v5, "National roaming [getDisplayRule] spn"
    ...
    const-string/jumbo v5, "spn.length()"
    ...
    const-string v4, "[getDisplayRule] national roaming - spn empty, showing plmn"
    ...
    const-string v4, "[getDisplayRule] Showing spn (spnDisplayCondition & 2 == 0)"
